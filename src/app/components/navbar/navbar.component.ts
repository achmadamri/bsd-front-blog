...
export class NavbarComponent implements OnInit {
    ...
    getTitle() {
        ...
        // CUSTOM AMRI
        // if (normTitle.match(/order edit.*/)) return "Order Edit";
        // if (normTitle.match(/product edit.*/)) return "Product Edit";
        // if (normTitle.match(/gwp edit.*/)) return "Gwp Edit";
